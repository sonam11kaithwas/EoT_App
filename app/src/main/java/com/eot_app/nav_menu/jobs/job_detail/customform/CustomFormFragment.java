...
public class CustomFormFragment extends androidx.fragment.app.Fragment implements View.OnClickListener, MyAttachment {//Cstm_Form_View,
    ...
    public static CustomFormFragment newInstance(String jobId, String queList) {
        ...
        switch (view.getId()) {
            case R.id.saveBtn:
                ...
                if (jobId.equals("RemarkActivity")) {
                    ...
                    ((FormQueAns_Activity) getActivity()).getAnsList(answerArrayList, signAns, docAns, signQueIdArray, docQueIdArray);
                }
