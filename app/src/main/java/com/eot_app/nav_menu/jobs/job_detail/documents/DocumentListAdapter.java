...
public class DocumentListAdapter extends RecyclerView.Adapter<DocumentListAdapter.MyView_Holder> implements Filterable {
    ...
    @Override
    public void onBindViewHolder(@NonNull final MyView_Holder holder, final int position) {
        ...
        holder.layout_doc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(getFileList_res.get(position).getType())) {
                    ...
                    } else if (getFileList_res.get(position).getType() != null && getFileList_res.get(position).getType().equals("5"))
